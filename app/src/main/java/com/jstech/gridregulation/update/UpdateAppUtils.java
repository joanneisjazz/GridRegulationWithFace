package com.jstech.gridregulation.update;
...
public class UpdateAppUtils {
     ...
     */
    public static void UpdateApp(Activity activity, Fragment fragment, int newVersionCode,
                                 String content, String downUrl, boolean IsUpdate) {
...
//            UpdateAppUtils.serviceVersionName=pi.versionName;
            UpdateAppUtils.serviceVersionName = String.valueOf(newVersionCode);
    ...
    private static void showDownLoadDialog() {
        AlertDialog dialog = new AlertDialog.Builder(mActivity).
                setCancelable(false).
                setTitle("更新到 版本：" + serviceVersionName).
                setMessage(content).
