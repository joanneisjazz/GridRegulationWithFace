package com.jstech.gridregulation.camera;
...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    private CameraHelper(CameraHelper.Builder builder) {
        ...
        mCallback = builder.pictureCallback;
    ...
    public void start() {
        synchronized (this) {
            ...
            Log.d("hesm", "displayOrientation" + displayOrientation);
...
//            mCamera.setDisplayOrientation(270);
    ...
    public static final class Builder {
        ...
        public Builder addPictureCallback(Camera.PictureCallback callback) {
